  ...
  return (
    <div className="App pt-5  max-w-7xl mx-auto my-0">
      	<h1 className="text-center text-4xl font-medium leading-2 text-gray-900">
			Memory Game Built with <img className="headline-icons" src={reactIcon} />
		...
		<div className="block max-w-6xl  px-12 py-10">
			<p className="">Icons created by <a href="https://illlustrations.co" target="_blank">vijay verma</a></p>
		</div>
    </div>
  )
}
